...
.method protected static guess([B[B)[Ljava/lang/String;
    ...
    .line 120
    invoke-static {v6, v8, v11}, Lcom/jcraft/jsch/Util;->byte2str([BII)Ljava/lang/String;
...
.method protected verify(Ljava/lang/String;[BI[B)Z
    ...
    invoke-static {p2, v2, p1, v5, v0}, Ljava/lang/System;->arraycopy(Ljava/lang/Object;ILjava/lang/Object;II)V
    ...
    invoke-virtual {p2, v0}, Lcom/jcraft/jsch/Session;->getConfig(Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 312
    :goto_6
    invoke-interface {p2, p3, p1}, Lcom/jcraft/jsch/SignatureECDSA;->setPubKey([B[B)V

    .line 314
    iget-object p1, p0, Lcom/jcraft/jsch/KeyExchange;->H:[B

    invoke-interface {p2, p1}, Lcom/jcraft/jsch/SignatureECDSA;->update([B)V
