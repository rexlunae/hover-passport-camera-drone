...
.method public constructor <init>(Lokhttp3/Request;Lokhttp3/WebSocketListener;Ljava/util/Random;)V
    ...
    invoke-virtual {p1}, Lb/f;->b()Ljava/lang/String;
...
.method private declared-synchronized send(Lb/f;I)Z
    .locals 8
    ...
    invoke-direct {v1, p2, p1}, Lokhttp3/internal/ws/RealWebSocket$Message;-><init>(ILb/f;)V
...
.method declared-synchronized close(ILjava/lang/String;J)Z
    ...
    invoke-direct {v2, p1, v0, p3, p4}, Lokhttp3/internal/ws/RealWebSocket$Close;-><init>(ILb/f;J)V
...
.method public initReaderAndWriter(Ljava/lang/String;JLokhttp3/internal/ws/RealWebSocket$Streams;)V
    ...
    iget-object v2, p4, Lokhttp3/internal/ws/RealWebSocket$Streams;->sink:Lb/d;

    iget-object v3, p0, Lokhttp3/internal/ws/RealWebSocket;->random:Ljava/util/Random;

    invoke-direct {v0, v1, v2, v3}, Lokhttp3/internal/ws/WebSocketWriter;-><init>(ZLb/d;Ljava/util/Random;)V
    ...
    iget-object p3, p4, Lokhttp3/internal/ws/RealWebSocket$Streams;->source:Lb/e;

    invoke-direct {p1, p2, p3, p0}, Lokhttp3/internal/ws/WebSocketReader;-><init>(ZLb/e;Lokhttp3/internal/ws/WebSocketReader$FrameCallback;)V
...
.method public onReadMessage(Lb/f;)V
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-virtual {v0, p0, p1}, Lokhttp3/WebSocketListener;->onMessage(Lokhttp3/WebSocket;Lb/f;)V
...
.method public declared-synchronized onReadPing(Lb/f;)V
    .locals 1
...
.method public declared-synchronized onReadPong(Lb/f;)V
    .locals 0
...
.method declared-synchronized pong(Lb/f;)Z
    .locals 1
...
.method public send(Lb/f;)Z
    ...
    .line 364
    invoke-direct {p0, p1, v0}, Lokhttp3/internal/ws/RealWebSocket;->send(Lb/f;I)Z
...
.method writeOneFrame()Z
    ...
    .line 477
    :try_start_1
    invoke-virtual {v0, v2}, Lokhttp3/internal/ws/WebSocketWriter;->writePong(Lb/f;)V
    ...
    iget-object v1, v1, Lokhttp3/internal/ws/RealWebSocket$Message;->data:Lb/f;
    ...
    .line 481
    invoke-virtual {v0, v2, v5, v6}, Lokhttp3/internal/ws/WebSocketWriter;->newMessageSink(IJ)Lb/s;
    ...
    .line 483
    invoke-interface {v0, v1}, Lb/d;->c(Lb/f;)Lb/d;
    ...
    iget-object v3, v5, Lokhttp3/internal/ws/RealWebSocket$Close;->reason:Lb/f;

    invoke-virtual {v0, v2, v3}, Lokhttp3/internal/ws/WebSocketWriter;->writeClose(ILb/f;)V
...
.method writePingFrame()V
    ...
    invoke-virtual {v0, v1}, Lokhttp3/internal/ws/WebSocketWriter;->writePing(Lb/f;)V
    :try_end_1
