...
# direct methods
.method constructor <init>(ZLb/e;Lokhttp3/internal/ws/WebSocketReader$FrameCallback;)V
    .locals 1
    ...
    .line 82
    iput-object p2, p0, Lokhttp3/internal/ws/WebSocketReader;->source:Lb/e;
...
.method private readControlFrame()V
    ...
    .line 172
    iget-object v1, p0, Lokhttp3/internal/ws/WebSocketReader;->source:Lb/e;

    iget-wide v2, p0, Lokhttp3/internal/ws/WebSocketReader;->frameLength:J

    invoke-interface {v1, v0, v2, v3}, Lb/e;->a(Lb/c;J)V
    ...
    .line 176
    iget-object v3, p0, Lokhttp3/internal/ws/WebSocketReader;->source:Lb/e;

    iget-object v4, p0, Lokhttp3/internal/ws/WebSocketReader;->maskBuffer:[B

    invoke-interface {v3, v4, v2, v1}, Lb/e;->a([BII)I
    ...
    invoke-virtual {v0, v3, v2, v1}, Lb/c;->b([BII)Lb/c;
    ...
    invoke-interface {v1, v0}, Lokhttp3/internal/ws/WebSocketReader$FrameCallback;->onReadPong(Lb/f;)V
    ...
    invoke-interface {v1, v0}, Lokhttp3/internal/ws/WebSocketReader$FrameCallback;->onReadPing(Lb/f;)V
...
.method private readHeader()V
    ...
    .line 110
    :cond_0
    iget-object v0, p0, Lokhttp3/internal/ws/WebSocketReader;->source:Lb/e;
    ...
    .line 111
    iget-object v2, p0, Lokhttp3/internal/ws/WebSocketReader;->source:Lb/e;

    invoke-interface {v2}, Lb/e;->timeout()Lb/u;

    move-result-object v2

    invoke-virtual {v2}, Lb/u;->clearTimeout()Lb/u;
    ...
    invoke-interface {v3}, Lb/e;->timeout()Lb/u;

    move-result-object v3

    sget-object v4, Ljava/util/concurrent/TimeUnit;->NANOSECONDS:Ljava/util/concurrent/TimeUnit;

    invoke-virtual {v3, v0, v1, v4}, Lb/u;->timeout(JLjava/util/concurrent/TimeUnit;)Lb/u;
    ...
    invoke-interface {v0, v1}, Lb/e;->a([B)V
...
.method private readMessage(Lb/c;)V
    .locals 12
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-interface {v0, v6, v3, v4}, Lb/e;->a([BII)I
    ...
    invoke-virtual {p1, v0, v3, v1}, Lb/c;->b([BII)Lb/c;
    ...
    invoke-interface {v0, p1, v4, v5}, Lb/e;->read(Lb/c;J)J
...
.method private readMessageFrame()V
    ...
    .line 219
    invoke-direct {p0, v2}, Lokhttp3/internal/ws/WebSocketReader;->readMessage(Lb/c;)V
    ...
    invoke-virtual {v2}, Lb/c;->r()Ljava/lang/String;
    ...
    invoke-virtual {v2}, Lb/c;->q()Lb/f;

    move-result-object v1

    invoke-interface {v0, v1}, Lokhttp3/internal/ws/WebSocketReader$FrameCallback;->onReadMessage(Lb/f;)V
