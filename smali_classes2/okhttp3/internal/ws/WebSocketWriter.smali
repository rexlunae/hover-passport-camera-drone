...
.method constructor <init>(ZLb/d;Ljava/util/Random;)V
    .locals 1
    ...
    iput-object v0, p0, Lokhttp3/internal/ws/WebSocketWriter;->buffer:Lb/c;
    ...
    .line 68
    iput-object p2, p0, Lokhttp3/internal/ws/WebSocketWriter;->sink:Lb/d;
...
.method private writeControlFrameSynchronized(ILb/f;)V
    .locals 7
    ...
    .line 132
    iget-object v2, p0, Lokhttp3/internal/ws/WebSocketWriter;->sink:Lb/d;

    invoke-interface {v2, p1}, Lb/d;->i(I)Lb/d;
    ...
    .line 137
    iget-object v0, p0, Lokhttp3/internal/ws/WebSocketWriter;->sink:Lb/d;

    invoke-interface {v0, p1}, Lb/d;->i(I)Lb/d;
    ...
    .line 140
    iget-object p1, p0, Lokhttp3/internal/ws/WebSocketWriter;->sink:Lb/d;
    ...
    .line 144
    iget-object p2, p0, Lokhttp3/internal/ws/WebSocketWriter;->sink:Lb/d;

    invoke-interface {p2, p1}, Lb/d;->c([B)Lb/d;
    ...
    invoke-interface {p1, p2}, Lb/d;->c(Lb/f;)Lb/d;
...
.method writeClose(ILb/f;)V
    ...
    .line 106
    invoke-virtual {v0, p2}, Lb/c;->a(Lb/f;)Lb/c;
    ...
    .line 113
    :try_start_0
    invoke-direct {p0, p1, v0}, Lokhttp3/internal/ws/WebSocketWriter;->writeControlFrameSynchronized(ILb/f;)V
    :try_end_0
...
.method writeMessageFrameSynchronized(IJZZ)V
    ...
    .line 182
    :cond_2
    iget-object p4, p0, Lokhttp3/internal/ws/WebSocketWriter;->sink:Lb/d;

    invoke-interface {p4, p1}, Lb/d;->i(I)Lb/d;
    ...
    invoke-interface {p1, p4}, Lb/d;->h(I)Lb/d;
    ...
    invoke-interface {p1, p2, p3}, Lb/d;->o(J)Lb/d;
    ...
    invoke-interface {p1, p4}, Lb/d;->c([B)Lb/d;
    ...
    .line 207
    iget-object v1, p0, Lokhttp3/internal/ws/WebSocketWriter;->buffer:Lb/c;

    iget-object v2, p0, Lokhttp3/internal/ws/WebSocketWriter;->maskBuffer:[B

    invoke-virtual {v1, v2, v0, p1}, Lb/c;->a([BII)I
    ...
    .line 210
    iget-object v1, p0, Lokhttp3/internal/ws/WebSocketWriter;->sink:Lb/d;

    iget-object v2, p0, Lokhttp3/internal/ws/WebSocketWriter;->maskBuffer:[B

    invoke-interface {v1, v2, v0, p1}, Lb/d;->c([BII)Lb/d;
    ...
    iget-object p4, p0, Lokhttp3/internal/ws/WebSocketWriter;->buffer:Lb/c;

    invoke-interface {p1, p4, p2, p3}, Lb/d;->write(Lb/c;J)V

    .line 217
    :cond_8
    iget-object p1, p0, Lokhttp3/internal/ws/WebSocketWriter;->sink:Lb/d;

    invoke-interface {p1}, Lb/d;->e()Lb/d;

    return-void
.end method

.method writePing(Lb/f;)V
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    .line 79
    :try_start_0
    invoke-direct {p0, v0, p1}, Lokhttp3/internal/ws/WebSocketWriter;->writeControlFrameSynchronized(ILb/f;)V
