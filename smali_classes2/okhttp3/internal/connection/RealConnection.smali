...
.method private connectSocket(II)V
    ...
    invoke-static {p1}, Lb/l;->b(Ljava/net/Socket;)Lb/t;
    ...
    invoke-static {p1}, Lb/l;->a(Ljava/net/Socket;)Lb/s;
...
.method private createTunnel(IILokhttp3/Request;Lokhttp3/HttpUrl;)Lokhttp3/Request;
    ...
    invoke-virtual {v1, v4, v5, v2}, Lb/u;->timeout(JLjava/util/concurrent/TimeUnit;)Lb/u;
    ...
    .line 345
    :cond_0
    invoke-virtual {v0, v1, v2}, Lokhttp3/internal/http1/Http1Codec;->newFixedLengthSource(J)Lb/t;
    ...
    invoke-static {v0, v1, v2}, Lokhttp3/internal/Util;->skipAll(Lb/t;ILjava/util/concurrent/TimeUnit;)Z
    ...
    invoke-interface {p1}, Lb/e;->b()Lb/c;
...
.method private establishProtocol(Lokhttp3/internal/connection/ConnectionSpecSelector;)V
    ...
    iget-object v2, p0, Lokhttp3/internal/connection/RealConnection;->source:Lb/e;

    iget-object v3, p0, Lokhttp3/internal/connection/RealConnection;->sink:Lb/d;

    invoke-virtual {p1, v0, v1, v2, v3}, Lokhttp3/internal/http2/Http2Connection$Builder;->socket(Ljava/net/Socket;Ljava/lang/String;Lb/e;Lb/d;)Lokhttp3/internal/http2/Http2Connection$Builder;
...
.method public connect(IIIZ)V
    ...
    .line 158
    iput-object v0, p0, Lokhttp3/internal/connection/RealConnection;->source:Lb/e;

    .line 159
    iput-object v0, p0, Lokhttp3/internal/connection/RealConnection;->sink:Lb/d;
...
.method public newCodec(Lokhttp3/OkHttpClient;Lokhttp3/internal/connection/StreamAllocation;)Lokhttp3/internal/http/HttpCodec;
    ...
    invoke-virtual {v0, v1, v2, v3}, Lb/u;->timeout(JLjava/util/concurrent/TimeUnit;)Lb/u;
    ...
    invoke-direct {v0, p1, p2, v1, v2}, Lokhttp3/internal/http1/Http1Codec;-><init>(Lokhttp3/OkHttpClient;Lokhttp3/internal/connection/StreamAllocation;Lb/e;Lb/d;)V
