...
.method constructor <init>(Lb/e;Z)V
    ...
    .line 71
    iput-object p1, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lb/e;
    ...
    iget-object p2, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lb/e;

    invoke-direct {p1, p2}, Lokhttp3/internal/http2/Http2Reader$ContinuationSource;-><init>(Lb/e;)V
    ...
    invoke-direct {p1, v0, p2}, Lokhttp3/internal/http2/Hpack$Reader;-><init>(ILb/t;)V
...
.method private readData(Lokhttp3/internal/http2/Http2Reader$Handler;IBI)V
    ...
    .line 211
    iget-object v0, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lb/e;
    ...
    .line 214
    iget-object p3, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lb/e;

    invoke-interface {p1, v1, p4, p3, p2}, Lokhttp3/internal/http2/Http2Reader$Handler;->data(ZILb/e;I)V

    .line 215
    iget-object p1, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lb/e;
...
.method private readGoAway(Lokhttp3/internal/http2/Http2Reader$Handler;IBI)V
    ...
    .line 319
    :cond_1
    iget-object p4, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lb/e;

    invoke-interface {p4}, Lb/e;->k()I

    move-result p4

    .line 320
    iget-object v2, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lb/e;
    ...
    invoke-interface {p3, v1, v2}, Lb/e;->d(J)Lb/f;

    move-result-object p3

    .line 330
    :cond_3
    invoke-interface {p1, p4, v0, p3}, Lokhttp3/internal/http2/Http2Reader$Handler;->goAway(ILokhttp3/internal/http2/ErrorCode;Lb/f;)V
...
.method static readMedium(Lb/e;)I
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
...
.method private readPriority(Lokhttp3/internal/http2/Http2Reader$Handler;I)V
    ...
    .line 229
    iget-object v3, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lb/e;
...
.method private readPushPromise(Lokhttp3/internal/http2/Http2Reader$Handler;IBI)V
    ...
    .line 298
    :cond_1
    iget-object v1, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lb/e;
...
.method public nextFrame(ZLokhttp3/internal/http2/Http2Reader$Handler;)Z
    ...
    invoke-interface {v1, v2, v3}, Lb/e;->a(J)V
    :try_end_0
    ...
    invoke-static {v1}, Lokhttp3/internal/http2/Http2Reader;->readMedium(Lb/e;)I
    ...
    invoke-interface {p1, v0, v1}, Lb/e;->i(J)V
...
.method public readConnectionPreface(Lokhttp3/internal/http2/Http2Reader$Handler;)V
    ...
    sget-object v0, Lokhttp3/internal/http2/Http2;->CONNECTION_PREFACE:Lb/f;
    ...
    invoke-interface {p1, v3, v4}, Lb/e;->d(J)Lb/f;
