...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lokhttp3/internal/http2/Http2Codec;->CONNECTION:Lb/f;
    ...
    sput-object v0, Lokhttp3/internal/http2/Http2Codec;->HOST:Lb/f;
    ...
    sput-object v0, Lokhttp3/internal/http2/Http2Codec;->KEEP_ALIVE:Lb/f;
    ...
    sput-object v0, Lokhttp3/internal/http2/Http2Codec;->PROXY_CONNECTION:Lb/f;
    ...
    sput-object v0, Lokhttp3/internal/http2/Http2Codec;->TRANSFER_ENCODING:Lb/f;
    ...
    sput-object v0, Lokhttp3/internal/http2/Http2Codec;->TE:Lb/f;
    ...
    sput-object v0, Lokhttp3/internal/http2/Http2Codec;->ENCODING:Lb/f;
    ...
    sput-object v0, Lokhttp3/internal/http2/Http2Codec;->UPGRADE:Lb/f;
    ...
    sget-object v1, Lokhttp3/internal/http2/Http2Codec;->CONNECTION:Lb/f;

    const/4 v2, 0x0

    aput-object v1, v0, v2

    sget-object v1, Lokhttp3/internal/http2/Http2Codec;->HOST:Lb/f;

    const/4 v3, 0x1

    aput-object v1, v0, v3

    sget-object v1, Lokhttp3/internal/http2/Http2Codec;->KEEP_ALIVE:Lb/f;

    const/4 v4, 0x2

    aput-object v1, v0, v4

    sget-object v1, Lokhttp3/internal/http2/Http2Codec;->PROXY_CONNECTION:Lb/f;

    const/4 v5, 0x3

    aput-object v1, v0, v5

    sget-object v1, Lokhttp3/internal/http2/Http2Codec;->TE:Lb/f;

    const/4 v6, 0x4

    aput-object v1, v0, v6

    sget-object v1, Lokhttp3/internal/http2/Http2Codec;->TRANSFER_ENCODING:Lb/f;

    const/4 v7, 0x5

    aput-object v1, v0, v7

    sget-object v1, Lokhttp3/internal/http2/Http2Codec;->ENCODING:Lb/f;

    const/4 v8, 0x6

    aput-object v1, v0, v8

    sget-object v1, Lokhttp3/internal/http2/Http2Codec;->UPGRADE:Lb/f;

    const/4 v9, 0x7

    aput-object v1, v0, v9

    sget-object v1, Lokhttp3/internal/http2/Header;->TARGET_METHOD:Lb/f;

    const/16 v10, 0x8

    aput-object v1, v0, v10

    sget-object v1, Lokhttp3/internal/http2/Header;->TARGET_PATH:Lb/f;

    const/16 v11, 0x9

    aput-object v1, v0, v11

    sget-object v1, Lokhttp3/internal/http2/Header;->TARGET_SCHEME:Lb/f;

    const/16 v11, 0xa

    aput-object v1, v0, v11

    sget-object v1, Lokhttp3/internal/http2/Header;->TARGET_AUTHORITY:Lb/f;
...
.method public static http2HeadersList(Lokhttp3/Request;)Ljava/util/List;
    ...
    sget-object v3, Lokhttp3/internal/http2/Header;->TARGET_METHOD:Lb/f;

    invoke-virtual {p0}, Lokhttp3/Request;->method()Ljava/lang/String;

    move-result-object v4

    invoke-direct {v2, v3, v4}, Lokhttp3/internal/http2/Header;-><init>(Lb/f;Ljava/lang/String;)V
    ...
    sget-object v3, Lokhttp3/internal/http2/Header;->TARGET_PATH:Lb/f;
    ...
    sget-object v4, Lokhttp3/internal/http2/Header;->TARGET_AUTHORITY:Lb/f;

    invoke-direct {v3, v4, v2}, Lokhttp3/internal/http2/Header;-><init>(Lb/f;Ljava/lang/String;)V
    ...
    sget-object v3, Lokhttp3/internal/http2/Header;->TARGET_SCHEME:Lb/f;
    ...
    invoke-direct {v2, v3, p0}, Lokhttp3/internal/http2/Header;-><init>(Lb/f;Ljava/lang/String;)V
    ...
    invoke-direct {v4, v3, v5}, Lokhttp3/internal/http2/Header;-><init>(Lb/f;Ljava/lang/String;)V
...
.method public static readHttp2HeadersList(Ljava/util/List;)Lokhttp3/Response$Builder;
    ...
    .line 166
    :cond_0
    iget-object v6, v5, Lokhttp3/internal/http2/Header;->name:Lb/f;

    .line 167
    iget-object v5, v5, Lokhttp3/internal/http2/Header;->value:Lb/f;
    ...
    .line 168
    sget-object v7, Lokhttp3/internal/http2/Header;->RESPONSE_STATUS:Lb/f;
    ...
    invoke-virtual {v6}, Lb/f;->a()Ljava/lang/String;
...
.method public createRequestBody(Lokhttp3/Request;J)Lb/s;
    ...
    invoke-virtual {p1}, Lokhttp3/internal/http2/Http2Stream;->getSink()Lb/s;
...
.method public finishRequest()V
    ...
    invoke-virtual {v0}, Lokhttp3/internal/http2/Http2Stream;->getSink()Lb/s;
...
.method public openResponseBody(Lokhttp3/Response;)Lokhttp3/ResponseBody;
    ...
    invoke-virtual {v1}, Lokhttp3/internal/http2/Http2Stream;->getSource()Lb/t;

    move-result-object v1

    invoke-direct {v0, p0, v1}, Lokhttp3/internal/http2/Http2Codec$StreamFinishingSource;-><init>(Lokhttp3/internal/http2/Http2Codec;Lb/t;)V
    ...
    invoke-direct {v1, p1, v0}, Lokhttp3/internal/http/RealResponseBody;-><init>(Lokhttp3/Headers;Lb/e;)V
...
.method public writeRequestHeaders(Lokhttp3/Request;)V
    ...
    invoke-virtual {p1}, Lokhttp3/internal/http2/Http2Stream;->readTimeout()Lb/u;
    ...
    invoke-virtual {p1, v0, v1, v2}, Lb/u;->timeout(JLjava/util/concurrent/TimeUnit;)Lb/u;

    .line 108
    iget-object p1, p0, Lokhttp3/internal/http2/Http2Codec;->stream:Lokhttp3/internal/http2/Http2Stream;

    invoke-virtual {p1}, Lokhttp3/internal/http2/Http2Stream;->writeTimeout()Lb/u;
