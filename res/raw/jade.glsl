...
lowp vec3 color1 = adjustHueSaturation(color0, vec3(0.02, -0.05, 0.00),0.0);
lowp vec3 color2 = adjustHueSaturation(color1, vec3(0.00, 0.00, -0.11),0.166667);
lowp vec3 color3 = adjustHueSaturation(color2, vec3(0.09, -0.28, -0.67),0.333333);
lowp vec3 color4 = adjustHueSaturation(color3, vec3(0.00, 0.40, -0.27),0.5);
lowp vec3 color5 = adjustHueSaturation(color4, vec3(0.00, -0.08, -0.09),0.666667);
lowp vec3 color6 = adjustHueSaturation(color5, vec3(0.00, 0.00, 0.17),0.833333);
