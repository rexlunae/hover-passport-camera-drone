...
lowp vec3 color2 = adjustHueSaturation(color1, vec3(0.00, -0.55, -0.29),0.0);
lowp vec3 color3 = adjustHueSaturation(color2, vec3(-0.02, -0.82, 0.45),0.166667);
lowp vec3 color4 = adjustHueSaturation(color3, vec3(-0.15, -0.78, 0.38),0.333333);
lowp vec3 color5 = adjustHueSaturation(color4, vec3(-0.06, -0.73, -0.12),0.5);
lowp vec3 color6 = adjustHueSaturation(color5, vec3(-0.09, -0.58, -0.31),0.666667);
lowp vec3 color7 = adjustHueSaturation(color6, vec3(0.00, -0.81, 0.22),0.833333);
lowp vec3 color8 = adjustSaturation(color7, 0.7000);
