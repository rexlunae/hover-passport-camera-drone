...
lowp vec3 color1 = adjustHueSaturation(color0, vec3(0.00, 0.00, -0.18),0.0);
lowp vec3 color2 = adjustHueSaturation(color1, vec3(-0.03, 0.04, 0.26),0.166667);
lowp vec3 color3 = adjustHueSaturation(color2, vec3(0.04, 0.00, 0.12),0.333333);
lowp vec3 color4 = adjustHueSaturation(color3, vec3(0.00, 0.00, 0.08),0.5);
lowp vec3 color5 = adjustHueSaturation(color4, vec3(0.04, 0.00, -0.19),0.833333);
lowp vec3 color6 = adjustHueSaturation(color5, vec3(0.00, 0.00, -0.39),0.666667);
