...
lowp vec3 color2 = adjustHueSaturation(color1, vec3(0.00, 0.10, 0.08),0.0);
lowp vec3 color3 = adjustHueSaturation(color2, vec3(0.00, 0.04, 0.24),0.166667);
lowp vec3 color4 = adjustHueSaturation(color3, vec3(0.00, -0.09, 0.17),0.333333);
lowp vec3 color5 = adjustHueSaturation(color4, vec3(0.00, 0.07, 0.64),0.5);
lowp vec3 color6 = adjustHueSaturation(color5, vec3(0.01, -0.36, 0.14),0.666667);
lowp vec3 color7 = adjustHueSaturation(color6, vec3(0.05, 0.03, 0.32),0.833333);
