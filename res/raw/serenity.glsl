...
void main() {
    ...
    mediump vec3 color1 = adjustVibrance(textureColor.rgb, 0.36);
    mediump vec3 color2 = adjustSelectiveColorRGB(color1, vec4(0.0, 0.0, 0.0, 0.16), 0);
    mediump vec3 color3 = adjustSelectiveColorCMY(color2, vec4(0.0, 0.0, -0.16, 0.0), 5);
    mediump vec3 color4 = adjustSelectiveColorRGB(color3, vec4(0.24, 0.24, -0.12, 0.0), 1);
    mediump vec3 color5 = adjustSelectiveColorWhite(color4, vec4(-0.15, 0.0, 0.0, -0.45), 7);
    mediump vec3 color6 = adjustSelectiveColorGray(color5, vec4(0.0, -0.1, 0.0, 0.0), 8);
    mediump vec3 color7 = adjustColorBalance(color6,
                                          vec3(-0.03, -0.03, 0.14),
                                          vec3(-0.05, 0, 0.12),
                                          vec3(0.02, 0.0, 0.0),
                                          true);
    mediump vec3 color8 = adjustCurve(color7);
