...
lowp vec3 color1 = adjustHueSaturation(color0, vec3(0.02, 0.00, 0.03),0.0);
lowp vec3 color2 = adjustHueSaturation(color1, vec3(0.00, 0.00, 0.13),0.166667);
lowp vec3 color3 = adjustHueSaturation(color2, vec3(0.00, 0.00, 0.23),0.333333);
lowp vec3 color4 = adjustHueSaturation(color3, vec3(0.00, -0.07, 0.24),0.5);
lowp vec3 color5 = adjustHueSaturation(color4, vec3(0.00, 0.00, -0.10),0.666667);
lowp vec3 color6 = adjustHueSaturation(color5, vec3(0.00, 0.00, -0.02),0.833333);
lowp vec3 color7 = adjustCurve(color6, inputImageTexture2);
gl_FragColor = vec4(color7, textureColor.a);
}
