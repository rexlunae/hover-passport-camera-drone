...
lowp vec3 color2 = adjustSaturation(color1, 0.9000);
lowp vec3 color3 = adjustHueSaturation(color2, vec3(0.00, -0.17, 0.00),0.333333);
gl_FragColor = vec4(color3, textureColor.a);
}
