...
lowp vec3 color1 = adjustHueSaturation(color0, vec3(0.03, -0.08, -0.03),0.0);
lowp vec3 color2 = adjustHueSaturation(color1, vec3(0.00, -0.43, 0.00),0.166667);
lowp vec3 color3 = adjustHueSaturation(color2, vec3(0.06, -0.53, -0.57),0.333333);
lowp vec3 color4 = adjustHueSaturation(color3, vec3(0.00, -0.20, -0.20),0.5);
lowp vec3 color5 = adjustHueSaturation(color4, vec3(0.00, 0.00, -0.11),0.666667);
lowp vec3 color6 = adjustHueSaturation(color5, vec3(0.00, 0.00, 0.19),0.833333);
