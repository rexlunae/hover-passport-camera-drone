...
lowp vec3 color1 = adjustHueSaturation(color0, vec3(0.01, 0.00, 0.06),0.0);
lowp vec3 color2 = adjustHueSaturation(color1, vec3(0.00, 0.00, -0.05),0.166667);
lowp vec3 color3 = adjustHueSaturation(color2, vec3(0.00, -0.07, 0.19),0.333333);
lowp vec3 color4 = adjustHueSaturation(color3, vec3(-0.01, 0.00, 0.19),0.5);
lowp vec3 color5 = adjustHueSaturation(color4, vec3(0.00, 0.00, -0.07),0.666667);
lowp vec3 color6 = adjustCurve(color5, inputImageTexture2);
