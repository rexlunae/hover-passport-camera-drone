...
lowp vec3 color2 = adjustHueSaturation(color1, vec3(0.03, 0.00, 0.05),0.0);
lowp vec3 color3 = adjustHueSaturation(color2, vec3(-0.07, 0.00, 0.28),0.666667);
lowp vec3 color4 = adjustHueSaturation(color3, vec3(0.00, 0.00, 0.56),0.833333);
gl_FragColor = vec4(color4, textureColor.a);
}
