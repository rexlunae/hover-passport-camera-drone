...
lowp vec3 color1 = adjustSaturation(color0, 0.8500);
lowp vec3 color2 = adjustHueSaturation(color1, vec3(0.01, -0.16, -0.07),0.0);
lowp vec3 color3 = adjustHueSaturation(color2, vec3(-0.06, 0.16, 0.23),0.166667);
lowp vec3 color4 = adjustHueSaturation(color3, vec3(-0.17, 0.01, 0.10),0.333333);
lowp vec3 color5 = adjustHueSaturation(color4, vec3(-0.07, -0.28, 0.10),0.5);
lowp vec3 color6 = adjustHueSaturation(color5, vec3(0.00, -0.08, 0.22),0.666667);
lowp vec3 color7 = adjustHueSaturation(color6, vec3(-0.03, -0.11, 0.10),0.833333);
