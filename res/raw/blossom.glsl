...
lowp vec3 color1 = adjustHueSaturation(color0, vec3(0.00, 0.00, -0.04),0.333333);
lowp vec3 color2 = adjustHueSaturation(color1, vec3(0.00, -0.02, 0.11),0.5);
lowp vec3 color3 = adjustHueSaturation(color2, vec3(0.00, -0.02, 0.11),0.666667);
lowp vec3 color4 = adjustHueSaturation(color3, vec3(0.00, 0.00, 0.12),0.833333);
lowp vec3 color5 = adjustCurve(color4, inputImageTexture2);
