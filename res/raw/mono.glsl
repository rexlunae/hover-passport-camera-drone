...
lowp vec3 color1 = adjustHueSaturation(color0, vec3(0.00, -1.00, -0.38),0.0);
lowp vec3 color2 = adjustHueSaturation(color1, vec3(0.00, -1.00, 0.80),0.166667);
lowp vec3 color3 = adjustHueSaturation(color2, vec3(0.00, -1.00, 0.18),0.333333);
lowp vec3 color4 = adjustHueSaturation(color3, vec3(0.00, -1.00, 0.34),0.5);
lowp vec3 color5 = adjustHueSaturation(color4, vec3(0.00, -1.00, -0.75),0.666667);
lowp vec3 color6 = adjustHueSaturation(color5, vec3(0.00, -1.00, -0.14),0.833333);
lowp vec3 color7 = adjustSaturation(color6, 0.0000);
lowp vec3 color8 = adjustCurve(color7, inputImageTexture2);
lowp vec3 color9 = adjustCurve(color8, inputImageTexture3);
