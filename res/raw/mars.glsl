...
lowp vec3 color2 = adjustHueSaturation(color1, vec3(0.00, -0.01, 0.01),0.0);
lowp vec3 color3 = adjustHueSaturation(color2, vec3(0.00, -0.13, 0.00),0.5);
lowp vec3 color4 = adjustHueSaturation(color3, vec3(0.00, -0.03, 0.00),0.666667);
