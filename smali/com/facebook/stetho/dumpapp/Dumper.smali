...
.method public constructor <init>(Ljava/lang/Iterable;)V
    ...
    invoke-direct {p0, p1, v0}, Lcom/facebook/stetho/dumpapp/Dumper;-><init>(Ljava/lang/Iterable;Lorg/apache/commons/cli/b;)V

    return-void
.end method

.method public constructor <init>(Ljava/lang/Iterable;Lorg/apache/commons/cli/b;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 44
    iput-object p2, p0, Lcom/facebook/stetho/dumpapp/Dumper;->mParser:Lorg/apache/commons/cli/b;
...
.method private doDump(Ljava/io/InputStream;Ljava/io/PrintStream;Ljava/io/PrintStream;[Ljava/lang/String;)I
    ...
    .line 93
    iget-object v0, p0, Lcom/facebook/stetho/dumpapp/Dumper;->mParser:Lorg/apache/commons/cli/b;

    iget-object v1, p0, Lcom/facebook/stetho/dumpapp/Dumper;->mGlobalOptions:Lcom/facebook/stetho/dumpapp/GlobalOptions;

    iget-object v1, v1, Lcom/facebook/stetho/dumpapp/GlobalOptions;->options:Lorg/apache/commons/cli/h;

    const/4 v2, 0x1

    invoke-interface {v0, v1, p4, v2}, Lorg/apache/commons/cli/b;->a(Lorg/apache/commons/cli/h;[Ljava/lang/String;Z)Lorg/apache/commons/cli/a;
    ...
    iget-object v0, v0, Lcom/facebook/stetho/dumpapp/GlobalOptions;->optionHelp:Lorg/apache/commons/cli/e;

    invoke-virtual {v0}, Lorg/apache/commons/cli/e;->b()Ljava/lang/String;

    move-result-object v0

    invoke-virtual {p4, v0}, Lorg/apache/commons/cli/a;->a(Ljava/lang/String;)Z
    ...
    iget-object v0, v0, Lcom/facebook/stetho/dumpapp/GlobalOptions;->optionListPlugins:Lorg/apache/commons/cli/e;
    ...
    .line 103
    :cond_1
    invoke-virtual {p4}, Lorg/apache/commons/cli/a;->a()Ljava/util/List;
    ...
    .line 104
    invoke-direct {p0, p1, p2, p3, p4}, Lcom/facebook/stetho/dumpapp/Dumper;->dumpPluginOutput(Ljava/io/InputStream;Ljava/io/PrintStream;Ljava/io/PrintStream;Lorg/apache/commons/cli/a;)V
...
.method private dumpPluginOutput(Ljava/io/InputStream;Ljava/io/PrintStream;Ljava/io/PrintStream;Lorg/apache/commons/cli/a;)V
    .locals 7
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lcom/facebook/stetho/dumpapp/DumpException;
    ...
    iget-object v4, p0, Lcom/facebook/stetho/dumpapp/Dumper;->mParser:Lorg/apache/commons/cli/b;
...
.method private dumpUsage(Ljava/io/PrintStream;)V
    ...
    .line 145
    new-instance v0, Lorg/apache/commons/cli/d;

    invoke-direct {v0}, Lorg/apache/commons/cli/d;-><init>()V
    ...
    .line 153
    :try_start_0
    invoke-virtual {v0}, Lorg/apache/commons/cli/d;->a()I

    move-result v2

    iget-object p1, p0, Lcom/facebook/stetho/dumpapp/Dumper;->mGlobalOptions:Lcom/facebook/stetho/dumpapp/GlobalOptions;

    iget-object v3, p1, Lcom/facebook/stetho/dumpapp/GlobalOptions;->options:Lorg/apache/commons/cli/h;

    .line 155
    invoke-virtual {v0}, Lorg/apache/commons/cli/d;->b()I

    move-result v4

    .line 156
    invoke-virtual {v0}, Lorg/apache/commons/cli/d;->c()I
    ...
    .line 151
    invoke-virtual/range {v0 .. v5}, Lorg/apache/commons/cli/d;->a(Ljava/io/PrintWriter;ILorg/apache/commons/cli/h;II)V
    :try_end_0
